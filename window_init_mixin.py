...
class WindowInitMixin:
    ...
    def _init_widgets(self):
        ...
        self.date_container_layout = QtWidgets.QHBoxLayout(self.date_container)
        self.date_container_layout.setContentsMargins(0, 0, 0, 0)
        self.date_container_layout.setSpacing(0)
        self.date_stack = QtWidgets.QWidget()
        self.date_stack_layout = QtWidgets.QVBoxLayout(self.date_stack)
        self.date_stack_layout.setContentsMargins(0, 0, 0, 0)
        self.date_stack_layout.setSpacing(0)
        self.date_stack_layout.addWidget(self.date_row, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.date_stack_layout.addWidget(self.hicri_date_label, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.date_container_layout.addWidget(self.date_switch_button, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.date_container_layout.addWidget(self.date_stack, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
