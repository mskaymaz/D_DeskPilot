...
status: review
owner: UNASSIGNED
updated: 2026-04-16 17:06 +03:00
scope: `eko` ve `ozet` cevap disiplini, tum pencerelerde topmost guclendirmesi, `derle` akisinin canli exe ciktisina kadar tamamlanmasi
...
handover:
- next: Gorev cubugu/Explorer yenilemelerinde topmost davranisini canli kullanarak gozlemle.
- risk: Windows kabuk katmani bazi sistem yuzeylerinde gecici olarak Z-order'i yine zorlayabilir.
