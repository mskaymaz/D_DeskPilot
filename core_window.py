...
class DraggableTransparentWindow(WindowLifecycleMixin, WindowMouseMixin, QtWidgets.QWidget, PencereGuncellemeKarishimi, PencereNavigasyonKarishimi, SerbestDuzenKarishimi):
